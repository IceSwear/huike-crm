...
public class SysFileServiceImpl implements ISysFileService{
	...
	public AjaxResult upload(MultipartFile file) {
		...
		try {
			...
			String filename ="huike-crm"+s+uuid+".pdf";
			/**
			 * 构建返回结果集ds
			 */
			...
			ajax.put("fileName", "/"+bucketName+"/"+filename);
//url需要进行截取
			ajax.put("url", minioConfig.getEndpoint()+":"+ minioConfig.getPort()+"/"+ minioConfig.getBucketName()+"/"+originalFilename);
			return ajax;
