...
public interface IReportService {
    ...
    IndexVo getIndexVo(String beginCreateTime, String endCreateTime);



    List<PieChartVO> subjectStatisticst(String beginCreateTime, String endCreateTime);


    VulnerabilityMapVo getVulnerabilityMap(String beginCreateTime, String endCreateTime);

    List<salesStatisticvo> salesStatistic(String beginCreateTime, String endCreateTime);

  List<Map<String,Object>> businessChangeStatistics(String beginCreateTime, String endCreateTime);
